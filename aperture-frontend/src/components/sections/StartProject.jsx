          ...
          >
            ...
            <div className="px-6 py-8 md:px-8 md:py-10">
              ...
              <div className="mt-8 grid grid-cols-1 gap-px border border-line bg-line sm:grid-cols-2">
                ...
                <div className="group flex flex-col gap-2 bg-paper p-5 transition-colors hover:bg-ink sm:col-span-2">
                  <span className="flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-smoke transition-colors group-hover:text-paper/60">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:gap-6">
                    <a
                      ...
                      className="text-base font-medium text-ink transition-colors hover:underline group-hover:text-paper"
                    >
                      Chat with us: {site.phone.primary.display}
                    </a>
                    <span className="hidden text-smoke group-hover:text-paper/40 sm:inline">·</span>
                    <a
                      ...
                      className="text-base font-medium text-ink transition-colors hover:underline group-hover:text-paper"
                    >
                      Chat with us: {site.phone.secondary.display}
                    </a>
                  </div>
                </div>
              </div>
