...
const socials = [
  {
    name: 'GitHub',
    abbr: 'GH',
    href: 'https://github.com/aperturewebs',
    label: 'Aperture on GitHub',
    icon: (
  ...
  },
  {
    name: 'LinkedIn',
    abbr: 'LI',
    href: 'https://linkedin.com/company/aperturewebs',
    label: 'Aperture on LinkedIn',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  },
  {
    name: 'Twitter',
    abbr: 'TW',
    href: 'https://twitter.com/aperturewebs',
    label: 'Aperture on Twitter / X',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  },
  {
    name: 'Instagram',
    abbr: 'IG',
    href: 'https://instagram.com/aperturewebs',
    label: 'Aperture on Instagram',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
      ...
      <div className="container mx-auto px-6 md:px-12 py-20">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-5 lg:gap-8">
          ...
          <Reveal className="lg:col-span-2">
            ...
            <p className="mb-2 text-sm leading-relaxed text-ash">
            ...
            <p className="mb-6 text-xs text-smoke">
              <a href="mailto:hello@aperturewebs.co.in" className="hover:text-ink transition-colors">hello@aperturewebs.co.in</a>
              {' · '}
              <a href="mailto:contact@aperturewebs.co.in" className="hover:text-ink transition-colors">contact@aperturewebs.co.in</a>
            </p>
        ...
        <div className="mt-20 flex flex-col items-center justify-between gap-4 border-t border-line pt-8 md:flex-row">
          <p className="text-xs uppercase tracking-[0.2em] text-smoke">
            © {new Date().getFullYear()} Aperture Technologies · aperturewebs.co.in
          </p>
